...
public class NotAuthenticatedException extends BaseException {
  ...
  private static final String DEFAULT_MESSAGE = ExceptionConstants.NOT_AUTHENTICATED;

  private static final HttpStatus DEFAULT_HTTP_STATUS = HttpStatus.FORBIDDEN;

  @Builder(builderMethodName = "childBuilder")
  public NotAuthenticatedException(HttpStatus httpStatus, String error, Object data,
