...
public class EntityNotFoundException extends BaseException {
  ...
  private static final String DEFAULT_MESSAGE = ExceptionConstants.ENTITY_NOT_FOUND;

  private static final HttpStatus DEFAULT_HTTP_STATUS = HttpStatus.NOT_FOUND;

  @Builder(builderMethodName = "childBuilder")
  public EntityNotFoundException(HttpStatus httpStatus, String error, Object data,
