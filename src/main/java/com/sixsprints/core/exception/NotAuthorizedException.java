...
public class NotAuthorizedException extends BaseException {
  ...
  private static final String DEFAULT_MESSAGE = ExceptionConstants.NOT_AUTHORIZED;

  private static final HttpStatus DEFAULT_HTTP_STATUS = HttpStatus.UNAUTHORIZED;

  @Builder(builderMethodName = "childBuilder")
  public NotAuthorizedException(HttpStatus httpStatus, String error, Object data,
